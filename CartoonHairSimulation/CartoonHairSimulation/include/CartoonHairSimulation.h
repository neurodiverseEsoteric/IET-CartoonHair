...
/*
	This class is responsible for all the setting up of the project application. It acts as the frame listener, key listener etc and is called
	by the program main loop. It sets up the camera, lights, controls, GUI, hair etc. It controls the animation, updates the physics engine and
	updates the hair animation.
*/
...
public:
	...
	//these are all the event handlers for the CEGUI graphical user interface - their purpose should be
	//self explantory from the names
...
protected:
	...
	//generate the head collision shape from the sphere primitive XML file generated in Blender
	...
	//GUI Widgets - we programmatically link these to the GUI widgets defined the .layout script created in CELayoutEditor
	...
	//time step variables for ensuring consistent Bullet physics performance
	int m_maxSubSteps;
	...
	//some booleans used for setting up the animations, camera control and so on
